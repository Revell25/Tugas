...
public class userService {
    ...
    public userService(String emails, String passwords)
    {
       ...
       String[][] data = 
        { 
            {"ilhamwick@gmail.com", "12345", "superAdmin"},
            {"fitrimar@gmail.com", "12345", "user"} 
        };
        String[][] histories =
        {
            {"ilhamwick@gmail.com","Fisika Dasar II","Sistem Digital","19-04-2020"},
            {"fitrimar@gmail.com","Dasar Komputer dan Pemrograman","Konsep Jaringan Komputer","19-04-2020"}
        };
        this.data = data;
